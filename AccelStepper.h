...
public:
    ...
    /// \param[in] forward void-returning procedure that will make a forward step
    /// \param[in] backward void-returning procedure that will make a backward step
    /// \param[in] between void-returning procedure that will called between two steps
    AccelStepper(void (*forward)(), void (*backward)(), void (*between)());
...
private:
    ...
    // The pointer to a between-step procedure
    void (*_between)();
};
